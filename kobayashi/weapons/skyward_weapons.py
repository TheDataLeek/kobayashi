...
class UmbrellaBarrageSystem(Weapon):
    def __init__(self, *args, **kwargs):
        super().__init__(
            ...
            min_class=2,
            notes=(
            'This weapon is designed to hit large numbers of small ships - such as Cargo Lighters or Drop Pods. A '
...
class DevourerLauncher(Weapon):
    def __init__(self, *args, **kwargs):
        super().__init__(
            ...
            hardpoints=3,
            notes=(
            'On a hit, the affected ship takes 1d10 + 5 damage at the beginning of each round. This damage continues ' \
